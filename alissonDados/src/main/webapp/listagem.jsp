				...
				<thead>
					...
					<tbody>
							...
							<tr>
								...
								<td>
									<div style="margin-left: 20px;">
										...
										<!-- <a href="https://www.example.com" target="_blank">Link</a> -->
											<svg style="color: #62f162; " xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
								...
								%>
									<div style="margin-left: 20px;">
										<a href="https://www.instagram.com/<%= cliente.getInstagram() %>" target="_blank">
										<!-- <a href="https://www.example.com" target="_blank">Link</a> -->
											<svg style="color: #b7177c; xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
								...
								%>
									...
									<div style="margin-left: 18px;">
										<a href="/alissonDados/cliente?id=<%=cliente.getId()%>&update=1">
										 <svg style="color: white;  xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
								...
								<td>
									<div style="margin-left: 18px;">
										<a href="/alissonDados/servlet?action=ActionShowCliente&id=<%=cliente.getId()%>&update=1">
								...
								<td>
									<div style="margin-left: 18px;">
										<a href="/alissonDados/servlet?action=ActionDelete&id=<%=cliente.getId()%>">
